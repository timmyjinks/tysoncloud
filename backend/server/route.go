...
func (s *Application) registerRoutes(
	...
	r.Handle("/projects/{project_id}/github_services/{github_service_id}/redeploy", clerkhttp.RequireHeaderAuthorization()(http.HandlerFunc(s.RedeployGithubService))).Methods("POST")
